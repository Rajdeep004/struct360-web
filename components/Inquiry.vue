					...
					<TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
						...
						<DialogPanel
							...
							<div class="flex w-full shrink-0 flex-col lg:flex-row">
								...
								<form action="https://formsubmit.co/b1c7057588121f9bb60f980c1291172c" method="POST" class="card-body space-y-2 lg:w-1/2">
									<h1 class="h3 lg:h1 mb-8">Inquiry Now!</h1>
									<UFormGroup label="Name">
										<UInput placeholder="Peter John" type="text" name="Name" icon="i-heroicons-user-circle" v-model="formdata.name" />
									</UFormGroup>
									<UFormGroup label="Contact Number">
										<UInput placeholder="+1-909-909-9999" type="tel" name="Contact" icon="i-heroicons-phone" v-model="formdata.phone" />
									</UFormGroup>

									<UFormGroup label="Email">
										<UInput placeholder="you@example.com" type="email" name="Email" icon="i-heroicons-envelope" v-model="formdata.email" />
									</UFormGroup>
									<UFormGroup label="Country">
										<UInput placeholder="Canada" type="text" name="Country" v-model="formdata.country" />
									</UFormGroup>
									...
									<UFormGroup label="Inquiry">
										<UTextarea placeholder="Message" type="text" name="Message" v-model="formdata.message" />
									</UFormGroup>
									<button
										class="px-4 py-2 bg-accent hover:bg-accent/90 text-white font-semibold rounded-lg"
										@click="val = !val"> Submit </button>
								</form>
							</div>
						</DialogPanel>
					</TransitionChild>
